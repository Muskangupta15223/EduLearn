...
class UserServiceTest {
    ...
    void createUser_setsDefaultRole() {
        ...
        verify(kafkaProducerService).sendUserSignupEvent(any(), any(), any(), any());
    }
    ...
    void getUsersByRole_returnsFilteredList() {
        when(repository.findByRoleIgnoreCase("ADMIN")).thenReturn(List.of(new UserProfile()));
    ...
    void updateUserRole_success() {
        ...
        verify(kafkaProducerService).sendUserRoleUpdatedEvent(any(), any(), any(), eq("INSTRUCTOR"));
    }
    ...
    void updateUserRole_deactivated_setsSuspendedStatus() {
        ...
        Optional<UserProfile> result = userService.updateUserRole(1L, "DEACTIVATED");
    ...
    void updateUserProfile_doesNotCreateMissingProfile() {
        ...
        Optional<UserProfile> saved = userService.updateUserProfile(8L, new UserProfile());
    ...
    void submitInstructorVerification_requiresSelfOrAdmin() {
        ...
        ResponseStatusException ex = assertThrows(ResponseStatusException.class, () ->
                userService.submitInstructorVerification(12L, "file.pdf", "file.pdf", 99L, "INSTRUCTOR"));
    ...
    void submitInstructorVerification_rejectsNonInstructor() {
        ...
        ResponseStatusException ex = assertThrows(ResponseStatusException.class, () ->
                userService.submitInstructorVerification(5L, "file.pdf", "file.pdf", 5L, "STUDENT"));
    ...
    void reviewInstructorVerification_requiresAdmin() {
        ResponseStatusException ex = assertThrows(ResponseStatusException.class, () ->
                userService.reviewInstructorVerification(12L, "APPROVED", "ok", 1L, "INSTRUCTOR"));
        assertEquals(HttpStatus.FORBIDDEN, ex.getStatusCode());
    }
    ...
    void reviewInstructorVerification_approvesRequest() {
        ...
        UserProfile result = userService.reviewInstructorVerification(12L, "APPROVED", "Good", 1L, "ADMIN");
    ...
    void reviewInstructorVerification_invalidStatus_throwsBadRequest() {
        ResponseStatusException ex = assertThrows(ResponseStatusException.class, () ->
                userService.reviewInstructorVerification(12L, "INVALID", "note", 1L, "ADMIN"));
        assertEquals(HttpStatus.BAD_REQUEST, ex.getStatusCode());
    }
    ...
    void getPendingInstructorVerifications_returnsList() {
        when(repository.findByRoleIgnoreCaseAndInstructorVerificationStatusIgnoreCase("INSTRUCTOR", "PENDING"))
