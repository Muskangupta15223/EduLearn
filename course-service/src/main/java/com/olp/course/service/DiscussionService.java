...
public class DiscussionService {
  ...
  private static final Long SEED_COURSE_ID = 1L;
  ...
  public void init() {
    if (threadRepository.count() == 0) {
      ...
      thread1.setCourseId(SEED_COURSE_ID);
      thread1.setTitle("Welcome to the course! Introduce yourselves.");
      thread1.setContent(
        "Hi everyone, please use this thread to introduce yourselves, share your background, and tell us what you hope to learn from this course."
      );
      ...
      reply1.setContent(
        "Hello! I'm Alice. I'm a software developer looking to improve my skills."
      );
      reply1.setUserId(2L);
      ...
      reply2.setContent(
        "Hi Alice, nice to meet you! I'm Bob, currently a student."
      );
      reply2.setUserId(3L);
      ...
      thread2.setCourseId(SEED_COURSE_ID);
      thread2.setTitle("Question about Module 1 Assignment");
      thread2.setContent(
        "I'm having trouble understanding the requirements for the second part of the assignment. Could anyone clarify?"
      );
      ...
      reply3.setContent(
        "Sure, the second part asks you to implement the interface provided in the starter code. Let me know if you need more help."
      );
      reply3.setUserId(1L);
      ...
      LOGGER.info(
        "Seeded default discussion threads and replies for courseId={}",
        SEED_COURSE_ID
      );
    }
  }
  ...
  public List<DiscussionThread> getThreadsByCourse(Long courseId) {
    return threadRepository.findByCourseIdOrderByIsPinnedDescCreatedAtDesc(
      courseId
    );
  }
    ...
    DiscussionThread thread = threadRepository
      ...
      .orElseThrow(() ->
        new ResponseStatusException(
          ...
          CourseConstants.MSG_THREAD_NOT_FOUND
        )
      );
  ...
  public DiscussionThread pinThread(
    Long threadId,
    Long userId,
    String role,
    boolean pinned
  ...
  public DiscussionThread closeThread(
    Long threadId,
    Long userId,
    String role,
    boolean closed
  ...
  public DiscussionReply acceptReply(
    Long threadId,
    Long replyId,
    Long userId,
    String role
    ...
    List<DiscussionReply> replies = replyRepository.findByThreadIdOrderByIsAcceptedDescUpvotesDescCreatedAtAsc(
      threadId
    );
  ...
  private void requireAuthorAdminOrModerator(
  ...
  private void requireAuthorAdminOrModerator(
    ...
    if (
      actorUserId != null &&
      ownerUserId != null &&
      ownerUserId.equals(actorUserId)
    ) {
      return;
    }
    if ("INSTRUCTOR".equalsIgnoreCase(actorRole)) {
      Course course = accessControlService.getOwnedCourse(
        thread.getCourseId(),
        actorUserId,
        actorRole
      );
  ...
  private void requireModerator(
    ...
    accessControlService.getOwnedCourse(
      thread.getCourseId(),
      actorUserId,
      actorRole
    );
